...
# Teste T
pairwise.t.test(dados_anova_simples$Crescimento, dados_anova_simples$Tratamento)
```
...
Percebam que o resultado da ANCOVA (Pr(>F) < 0.001) indica que tanto a herbivoria como a o tamanho da raiz (covariável) tem efeitos significativos na biomassa dos frutos.
